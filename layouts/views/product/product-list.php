<section>
        <div class="container d-flex d-sm-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center my-3">
            <form class="d-inline-flex"><input class="form-control form-control-sm me-1 search-input" type="text" placeholder="Search ..."><button class="btn btn-dark px-2 py-0" type="submit" style="padding: 0px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-search fs-5 text-light px-0 pe-0">
