<section>
        <form class="my-md-3 mb-4 was-validated" method="post" action="/product-upload" enctype="multipart/form-data">
            ...
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><input class="form-control my-md-1" required type="text" name="name"></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><input class="form-control my-md-1" required type="text" name="price"></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><input required class="form-control my-md-1" type="text" name="color"></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-5 my-md-2">
            ...
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><input class="form-control my-md-1"required type="number" min="0" name="inStock"></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><input class="form-control form-control-sm mt-md-1" required type="file" name="image"></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-5 my-md-2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7"><textarea class="form-control form-control-lg mb-3 fs-6" required name="detail"></textarea></div>
                    </div>
                </div>
            </div>
            <div class="mx-md-0">
